...
problem. This framework served as a scaffolding for investigation into the
...
presented in the theoretical framework developed in
...
approach, which is evident in the parallels between the theoretical framework
