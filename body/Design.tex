...
\Figure[width=1\columnwidth, angle=90, scale=1.2]{UML Diagram Outlining the MOT System Class Structure}{design_uml} 
...
In line with these requirements, Figure~\ref{fig:design_gui_mockup} 

\Figure[width=1\columnwidth]{Graphical User Interface Mockup}{design_gui_mockup} 
