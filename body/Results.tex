...
\Figure[width=0.8\columnwidth]{Graph of tracker error of ATT (pixels) vs frames in sequence}{results/adaptive_template_tracker/metric.png}
...
\Figure[width=0.8\columnwidth]{Graph of tracker error of MST (pixels) vs frames in fish sequence}{results/mean_shift_tracker/fish3/metric.png}
...
\Figure[width=0.8\columnwidth]{Graph of tracker error of MST (pixels) vs frames in girl sequence}{results/mean_shift_tracker/girl/metric.png}
...
From the graph in Figure~\ref{fig:results/results/mean_shift_tracker/girl/metric.png}, it is
apparent by the large spike in tracker error that the MST deals poorly with the
challenge of complete occlusion.  This is expected as the implementation of the
MST is based on visual low-level features of the RGB colour space. It does
however relocate the girl relatively fast after the occlusion ends, but it this
would not necessarily be the can in the case of longer occlusion periods that
could allow the tracker to drift too far to relocate the target model. 

Figure~\ref{fig:mean_shift_complete_occlusion} provides a visual insight into
...
\Figure[width=0.8\columnwidth]{Graph of tracker error of adaptive tracker (pixels) vs frames in ant sequence}{results/mean_shift_tracker/ants/metric.png}
...
From the graph in Figure~\ref{fig:results/mean_shift_tracker/girl/metric.png},
...
\Figure[width=1\columnwidth]{Image of the MOT System GUI implementation applying the MS-Tracker to a fish sequence}{results/gui/first_look}
