...
Figure~\ref{fig:results/mean_shift_tracker/results_m_pdf}. There is not significant trend shown between the
...
detailed in Figure~\ref{fig:results/mean_shift_tracker/results_m_bc}. The execution time of the
...
\subsection{Experiment 1: fish}\label{results_fish}
