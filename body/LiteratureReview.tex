...
There are various approaches to object detection.
...
\Figure[width=0.7\columnwidth]{Taxonomy of object detection approaches}{literaturereview_taxonomy_motion_detection}
...
representations include. Figure
