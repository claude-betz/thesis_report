...
The problem discussed of isolating moving objects of interest from a scene can
be categorised under the branch of Computer Vision known as Motion
Estimation/Tracking.

This literature review starts by broadly detailing the general approach to
solving of Motion Tracking problems. This is followed by a study of the
progression of the field; This involves a review of prominent “classical”
pre-deep learning approaches to the problem, followed by a brief review of the
relatively recent benefits that deep learning approaches offer.
...
\subsection{A General Approach to Motion Tracking}
...
subtasks of the overall Motion Tracking Task. The most prominent of each are
reviewed below:
