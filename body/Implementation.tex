...
functionality. The \lstinline{imageView} class that subclasses the \lstinline{QLabel} class is created.
...
This behaviour is facilitated by the \lstinline{QRubberband} class. We emit the results as
...
# step1: import relevant back-end class
...
integration of the MST with the front-end GUI\@. The significant point is that
calls to the deeper
