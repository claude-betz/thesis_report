...
The controllers of the system are within the. The contollercomprise of the file menu, toolbar,
        buttons, and the views that a user can use to interact with the system.
\subsection{Views}
The GUI application has two views, one to display the sequence, and one to
