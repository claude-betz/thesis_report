...
the following functions begin available
\begin{itemize}
    \item get\_pdf (roi, m)
...
This Section deals with the front-end implementation of the MT system which is
in form of a GUI which interfaces with the back-end classes to satisfy the
system user requirements.
The GUI was implemented by use of the pyQt5 python3 library and it's layout
follows the closely that of the mock-up designed mock-up in Figure~\ref{fig:design_gui_mockup}
