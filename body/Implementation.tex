...
defined, including it's connection to it's slot (snippet 2). The slot- which
specifies the GUI response a user selection of the ``Select Sequence'' menu
option is shown in snippet 3.
Other controllers in the GUI follow a similar implementation pattern.
